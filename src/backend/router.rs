use super::{
    ...
    routes::{
        ...
        auth::{
            ...
            register, revoke_session, server_info, totp_setup, totp_verify,
        },
...
pub(crate) fn build_router() -> Router<Arc<AppState>> {
    ...
    Router::new()
        ...
        .route(
            "/api/account/force-reset-password",
        ...
        .route(
            "/api/rooms/{room_id}/members/{user_id}/role",
            put(set_member_role),
        )
        ...
        // Custom Roles
        .route(
            "/api/rooms/{room_id}/roles",
            get(list_roles).post(create_role),
        )
        .route(
            "/api/rooms/{room_id}/roles/{role_id}",
            put(update_role).delete(delete_role),
        )
        .route(
            "/api/rooms/{room_id}/members/{user_id}/custom-roles",
            get(get_member_roles).put(assign_member_roles),
        )
        .route(
        ...
        .route(
            "/api/rooms/{room_id}/threads/{event_id}",
            get(get_thread_messages),
        )
        .route(
            "/api/rooms/{room_id}/threads/{event_id}/name",
            put(set_thread_name),
        )
        .route(
            "/api/rooms/{room_id}/threads/{event_id}",
        ...
        .route(
            "/api/rooms/{room_id}/threads/{event_id}/{txn_id}",
            put(send_thread_message),
        )
        // Search
        ...
        .route(
            "/api/bots/{bot_id}/regenerate-token",
            post(regenerate_bot_token),
        )
        // Webhooks
        .route(
            "/api/rooms/{room_id}/webhooks",
        ...
        .route(
            "/api/forum/{room_id}/posts/{post_id}/comments",
            post(create_comment),
        )
        .route(
        ...
        .route(
            "/api/room-groups/{group_id}/collapsed",
            put(set_group_collapsed),
        )
        // Friends
        ...
        .route(
            "/api/admin/settings/refresh-invite",
